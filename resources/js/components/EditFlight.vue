<template>
    <div class="container" v-if="new_row">
        <div class="card">
            ...
            <div class="card-footer">
                <div class="col ">
                    <button @click="update_flight" class="btn btn-outline-success ml-auto" :class="{ disabled: disabled_store_btn }" :disabled="disabled_store_btn">Atnaujinti</button>
                </div>
            </div>
        </div>
    </div>
    ...
    export default {
        ...
        methods: {
            update_flight() {
                ...
                axios.post('/update_flight', this.new_row).then(res => {
